...
/** \mainpage RoboComp::pioneer_dual_realsense
 *
 * \section intro_sec Introduction
 *
 * The pioneer_dual_realsense component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/pioneer_dual_realsense --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class pioneer_dual_realsense : public RoboComp::Application
{
public:
	pioneer_dual_realsense (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::pioneer_dual_realsense::initialize()
{
...
int ::pioneer_dual_realsense::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::pioneer_dual_realsense app(prefix, startup_check_flag);
